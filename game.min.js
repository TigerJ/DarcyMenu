...
// lib/plugins/darcy.js
ig.baked=true;ig.module('plugins.darcy').requires('impact.impact','impact.system').defines(function(){ig.Darcy=ig.Class.extend({MenuItems:[],ButtonProperties:{Font:"",FontFillStyle:"",FontFillOverStyle:"",TextAlign:"center",Stroke:false,StrokeType:"",Corner:0,ButtonSize:{x:0,y:0},Spacing:{x:0,y:0},DrawBoxes:false,BoxStrokeStyle:null,BoxStrokeWidth:null},MenuStart:{x:0,y:0},MenuLayout:"",DrawMenuBorder:false,DrawMenuFill:false,MenuSize:{width:0,height:0},MenuPadding:{x:0,y:0},MenuBorderStyle:"",MenuBorderWidth:"",MenuBorderCorner:0,MenuFillFillStyle:"",MenuFillCorner:0,init:function(){},update:function(){this.updateMenuItems();},updateMenuItems:function()
{for(i=0;i<this.MenuItems.length;i++)
{this.MenuItems[i].update();}},draw:function(){if(this.isImpactfont)
{}
else
{if(this.DrawMenuBorder)
{if(this.MenuBorderCorner==0||this.MenuBorderCorner==undefined)
{console.log(this.MenuStart.x+this.MenuSize.width);ig.system.context.strokeStyle=this.MenuBorderStyle;ig.system.context.lineWidth=this.MenuBorderWidth;ig.system.context.strokeRect(this.MenuStart.x,this.MenuStart.y,this.MenuStart.x+this.MenuSize.width,this.MenuStart.y+this.MenuSize.height);}}
for(i=0;i<this.MenuItems.length;i++)
{if(this.DrawBoxes)
{ig.system.context.StrokeStyle=this.ButtonProperties.BoxStrokeStyle;ig.system.context.LineWidth=this.ButtonProperties.BoxStrokeWidth;}
this.drawBackgrounds();this.drawTexts();this.drawBorders();}}},drawTexts:function()
{for(i=0;i<this.MenuItems.length;i++)
{this.MenuItems[i].drawText();}},drawBorders:function()
{for(i=0;i<this.MenuItems.length;i++)
{this.MenuItems[i].drawBorders();}},drawBackgrounds:function()
{for(i=0;i<this.MenuItems.length;i++)
{this.MenuItems[i].drawBackground();}},addItem:function(menutext,menulabel,inputAction,inputEvent){var dItem=new ig.DarcyItem();dItem.text=menutext;dItem.label=menulabel;dItem.inputAction=inputAction;dItem.inputEvent=inputEvent;dItem.drawBox=this.ButtonProperties.DrawBoxes;dItem.boxStrokeStyle=this.ButtonProperties.BoxStrokeStyle;dItem.boxStrokeWidth=this.ButtonProperties.BoxStrokeWidth;dItem.CornerRad=this.ButtonProperties.Corner;dItem.MenuLayout=this.MenuLayout;dItem.FontFillStyle=this.ButtonProperties.FontFillStyle;dItem.FontFillOverStyle=this.ButtonProperties.FontFillOverStyle;dItem.Font=this.ButtonProperties.Font;dItem.TextAlign=this.ButtonProperties.TextAlign;dItem.BackFillOverStyle=this.ButtonProperties.BackFillOverStyle;dItem.BackFillStyle=this.ButtonProperties.BackFillStyle;var spaceFirst={x:0,y:0};if(this.MenuLayout=="V")
{dItem.leftBounds=this.MenuStart.x+spaceFirst.x;dItem.rightBounds=this.MenuStart.x+(this.ButtonProperties.ButtonSize.x);dItem.upperBounds=this.MenuStart.y+spaceFirst.y+((this.ButtonProperties.ButtonSize.y+this.ButtonProperties.Spacing.y)*(this.MenuItems.length));dItem.lowerBounds=this.MenuStart.y+((this.ButtonProperties.ButtonSize.y+this.ButtonProperties.Spacing.y)*(this.MenuItems.length))+this.ButtonProperties.ButtonSize.y;}
if(this.MenuLayout=="H")
{if(this.MenuItems.length==0)
{spaceFirst={x:this.MenuPadding.x,y:this.MenuPadding.y};}
else
{spaceFirst={x:0,y:this.MenuPadding.y};}
dItem.leftBounds=this.MenuStart.x+spaceFirst.x+((this.ButtonProperties.ButtonSize.x+this.ButtonProperties.Spacing.x)*(this.MenuItems.length));dItem.rightBounds=this.MenuStart.x+((this.ButtonProperties.ButtonSize.x+this.ButtonProperties.Spacing.x)*(this.MenuItems.length))+this.ButtonProperties.ButtonSize.x;dItem.upperBounds=this.MenuStart.y+spaceFirst.y;dItem.lowerBounds=this.MenuStart.y+(this.ButtonProperties.ButtonSize.y);}
this.MenuItems.push(dItem);},rebuildMenu:function()
{for(i=0;i<this.MenuItems.length;i++)
{if(this.MenuLayout=="V")
{this.MenuItems[i].leftBounds=this.MenuStart.x;this.MenuItems[i].rightBounds=this.MenuStart.x+(this.ButtonProperties.ButtonSize.x);this.MenuItems[i].upperBounds=this.MenuStart.y+((this.ButtonProperties.ButtonSize.y+this.Spacing.y)*(i));this.MenuItems[i].lowerBounds=this.MenuStart.y+((this.ButtonProperties.ButtonSize.y+this.Spacing.y)*(i))+this.ButtonProperties.ButtonSize.y;}
if(this.MenuLayout=="H")
{this.MenuItems[i].leftBounds=this.MenuStart.x+((this.ButtonProperties.ButtonSize.x+this.ButtonProperties.Spacing.x)*(i));this.MenuItems[i].rightBounds=this.MenuStart.x+((this.ButtonProperties.ButtonSize.x+this.ButtonProperties.Spacing.x)*(i))+this.ButtonProperties.ButtonSize.x;this.MenuItems[i].upperBounds=this.MenuStart.y;this.MenuItems[i].lowerBounds=this.MenuStart.y+(this.ButtonProperties.ButtonSize.y);}}},removeItem:function(label)
{}});ig.DarcyItem=ig.Class.extend({update:function(){if(ig.input.mouse.x*2>this.leftBounds&&ig.input.mouse.x*2<this.rightBounds&&ig.input.mouse.y*2>this.upperBounds&&ig.input.mouse.y*2<this.lowerBounds)
{this.isOver=true;if(ig.input.pressed(this.inputAction))
{this.inputEvent();}}
else
{this.isOver=false;}},drawText:function(){if(this.isOver)
{ig.system.context.fillStyle=this.FontFillOverStyle;ig.system.context.textAlign=this.TextAlign;ig.system.context.font=this.Font;}
else
{ig.system.context.fillStyle=this.FontFillStyle;ig.system.context.textAlign=this.TextAlign;ig.system.context.font=this.Font;}
ig.system.context.fillText(this.text,this.leftBounds+((this.rightBounds-this.leftBounds)/2),this.lowerBounds-((this.lowerBounds-this.upperBounds)/2)+(this.boxStrokeWidth*2));},drawBackground:function(){if(this.isOver)
...
{rectWidth=this.rightBounds-this.leftBounds;rectHeight=this.lowerBounds-this.upperBounds;rectX=this.leftBounds;rectY=this.upperBounds;cornerRadius=this.CornerRad;ig.system.context.beginPath();ig.system.context.moveTo(rectX+cornerRadius,rectY);ig.system.context.lineTo(rectX+rectWidth-cornerRadius,rectY);ig.system.context.arcTo(rectX+rectWidth,rectY,rectX+rectWidth,rectY+cornerRadius,cornerRadius);ig.system.context.lineTo(rectX+rectWidth,rectY+rectHeight-cornerRadius);ig.system.context.arcTo(rectX+rectWidth,rectY+rectHeight,rectX-cornerRadius,rectY+rectHeight,cornerRadius);ig.system.context.lineTo(rectX+cornerRadius,rectY+rectHeight);ig.system.context.arcTo(rectX,rectY+rectHeight,rectX,rectHeight-cornerRadius,cornerRadius);ig.system.context.lineTo(rectX,rectY+cornerRadius);ig.system.context.arcTo(rectX,rectY,rectX+cornerRadius,rectY,cornerRadius);ig.system.context.fill();}},drawBorders:function(){if(this.drawBox&&(this.CornerRad==0||this.CornerRad==undefined))
{ig.system.context.strokeStyle=this.boxStrokeStyle;ig.system.context.lineWidth=this.boxStrokeWidth;ig.system.context.strokeRect(this.leftBounds,this.upperBounds,this.rightBounds-this.leftBounds,this.lowerBounds-this.upperBounds);}
if(this.drawBox&&this.CornerRad>0)
{ig.system.context.strokeStyle=this.boxStrokeStyle;ig.system.context.lineWidth=this.boxStrokeWidth;rectWidth=this.rightBounds-this.leftBounds;rectHeight=this.lowerBounds-this.upperBounds;rectX=this.leftBounds;rectY=this.upperBounds;cornerRadius=this.CornerRad;ig.system.context.beginPath();ig.system.context.moveTo(rectX+cornerRadius,rectY);ig.system.context.lineTo(rectX+rectWidth-cornerRadius,rectY);ig.system.context.arcTo(rectX+rectWidth,rectY,rectX+rectWidth,rectY+cornerRadius,cornerRadius);ig.system.context.lineTo(rectX+rectWidth,rectY+rectHeight-cornerRadius);ig.system.context.arcTo(rectX+rectWidth,rectY+rectHeight,rectX-cornerRadius,rectY+rectHeight,cornerRadius);ig.system.context.lineTo(rectX+cornerRadius,rectY+rectHeight);ig.system.context.arcTo(rectX,rectY+rectHeight,rectX,rectHeight-cornerRadius,cornerRadius);ig.system.context.lineTo(rectX,rectY+cornerRadius);ig.system.context.arcTo(rectX,rectY,rectX+cornerRadius,rectY,cornerRadius);ig.system.context.stroke();}}});});
...
// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','impact.font','plugins.darcy','impact.debug.debug').defines(function(){MyGame=ig.Game.extend({font:new ig.Font('media/04b03.font.png'),darcy:new ig.Darcy(),darcy2:new ig.Darcy(),init:function(){ig.input.bind(ig.KEY.MOUSE1,'shoot');this.darcy.ButtonProperties={FontFillStyle:"red",FontFillOverStyle:"white",Font:"14pt arial",TextAlign:"center",Spacing:{x:5,y:5},ButtonSize:{x:100,y:30},DrawBoxes:true,BoxStrokeStyle:"#fff",BoxStrokeWidth:2,Corner:5,BackFillOverStyle:"pink",BackFillStyle:"purple"};this.darcy.DrawMenuBorder=true;this.darcy.MenuBorderStyle="orange";this.darcy.MenuBorderWidth="2";this.darcy.MenuBorderCorner=0;this.darcy.MenuLayout="H";this.darcy.MenuStart.x=5;this.darcy.MenuStart.y=5;this.darcy.MenuSize={width:310,height:30};this.darcy.MenuPadding={x:5,y:5};this.darcy.addItem("voilett","dog","shoot",function(){console.log("german shepard dog");});this.darcy.addItem("polaris","cat","shoot",function(){console.log("black cat");});this.darcy.addItem("atticus","horse","shoot",function(){console.log("horse");});this.darcy2.ButtonProperties={FontFillOverStyle:"white",FontFillStyle:"red",Font:"12pt serif",TextAlign:"center",Spacing:{x:5,y:5},ButtonSize:{x:100,y:20},DrawBoxes:true,BoxStrokeStyle:"#fff",BoxStrokeWidth:2,BackFillOverStyle:"grey",BackFillStyle:"brown"};this.darcy2.MenuLayout="V";this.darcy2.MenuStart.x=20;this.darcy2.MenuStart.y=65;this.darcy2.addItem("voilett","dog","shoot",function(){console.log("german shepard dog");});this.darcy2.addItem("polaris","cat","shoot",function(){console.log("black cat");});this.darcy2.addItem("atticus","horse","shoot",function(){console.log("horse");});},update:function(){this.darcy.update();this.darcy2.update();this.parent();},draw:function(){this.parent();var x=ig.system.width/2,y=ig.system.height/2;this.font.draw('It Works!',x,y,ig.Font.ALIGN.CENTER);this.darcy.draw();this.darcy2.draw();}});ig.main('#canvas',MyGame,60,320,240,2);});