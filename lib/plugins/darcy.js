...
.defines(function(){
    ig.Darcy = ig.Class.extend({
        ...
        addItem: function(menutext, menulabel, inputAction, inputEvent){
            ...
            dItem.BoxStrokeOverStyle = this.ButtonProperties.BoxStrokeOverStyle;
    ...
    ig.DarcyItem = ig.Class.extend({
        ...
        drawBorders: function(){
            ...
            if(this.isOver)
            {
                StrokeStyle=this.BoxStrokeOverStyle;
                //set over style for button border
            }
            else
            {
                StrokeStyle=this.boxStrokeStyle;
                //revert
            }
            ...
            {
                CT.drawContextStrokeRect(StrokeStyle,this.boxStrokeWidth,this.leftBounds,this.upperBounds,this.rightBounds-this.leftBounds,this.lowerBounds-this.upperBounds);
            }
            if(this.drawBox&&this.CornerRad>0)
            {
                CT.drawContextStrokeRectCorner(StrokeStyle,this.boxStrokeWidth,this.rightBounds-this.leftBounds,this.lowerBounds-this.upperBounds,this.leftBounds,this.upperBounds,this.CornerRad);
            }
        }
    });
