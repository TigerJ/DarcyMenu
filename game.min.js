...
this.drawBackgrounds();this.drawTexts();this.drawBorders();}
...
{CT.drawContextStrokeRect(this.MenuBorderStyle,this.MenuBorderWidth,this.MenuStart.x,this.MenuStart.y,this.ButtonProperties.ButtonSize.x+this.ButtonProperties.Spacing.x+this.ButtonProperties.Spacing.x,((this.ButtonProperties.ButtonSize.y+this.ButtonProperties.Spacing.y)*this.MenuItems.length)+this.ButtonProperties.Spacing.y);}}}}}},drawTexts:function()
{for(i=0;i<this.MenuItems.length;i++)
...
{rectWidth=this.rightBounds-this.leftBounds;rectHeight=this.lowerBounds-this.upperBounds;rectX=this.leftBounds;rectY=this.upperBounds;cornerRadius=this.CornerRad;ig.system.context.beginPath();ig.system.context.moveTo(rectX+cornerRadius,rectY);ig.system.context.lineTo(rectX+rectWidth-cornerRadius,rectY);ig.system.context.arcTo(rectX+rectWidth,rectY,rectX+rectWidth,rectY+cornerRadius,cornerRadius);ig.system.context.lineTo(rectX+rectWidth,rectY+rectHeight-cornerRadius);ig.system.context.arcTo(rectX+rectWidth,rectY+rectHeight,rectX-cornerRadius,rectY+rectHeight,cornerRadius);ig.system.context.lineTo(rectX+cornerRadius,rectY+rectHeight);ig.system.context.arcTo(rectX,rectY+rectHeight,rectX,rectHeight-cornerRadius,cornerRadius);ig.system.context.lineTo(rectX,rectY+cornerRadius);ig.system.context.arcTo(rectX,rectY,rectX+cornerRadius,rectY,cornerRadius);ig.system.context.fill();}},drawBorders:function(){var CT=new ig.ContextTools();if(this.drawBox&&(this.CornerRad==0||this.CornerRad==undefined))
...
{CT.drawContextStrokeRectCorner(this.boxStrokeStyle,this.boxStrokeWidth,this.rightBounds-this.leftBounds,this.lowerBounds-this.upperBounds,this.leftBounds,this.upperBounds,this.CornerRad);}}});ig.ContextTools=ig.Class.extend({drawContextStrokeRect:function(StrokeStyle,LineWidth,x1,y1,x2,y2){ig.system.context.strokeStyle=StrokeStyle;ig.system.context.lineWidth=LineWidth;ig.system.context.strokeRect(x1,y1,x2,y2);},drawContextStrokeRectCorner:function(StrokeStyle,LineWidth,rW,rH,rX,rY,cR)
{ig.system.context.strokeStyle=StrokeStyle;ig.system.context.lineWidth=LineWidth;ig.system.context.beginPath();ig.system.context.moveTo(rX+cR,rY);ig.system.context.lineTo(rX+rW-cR,rY);ig.system.context.arcTo(rX+rW,rY,rX+rW,rY+cR,cR);ig.system.context.lineTo(rX+rW,rY+rH-cR);ig.system.context.arcTo(rX+rW,rY+rH,rX-cR,rY+rH,cR);ig.system.context.lineTo(rX+cR,rY+rH);ig.system.context.arcTo(rX,rY+rH,rX,rH-cR,cR);ig.system.context.lineTo(rX,rY+cR);ig.system.context.arcTo(rX,rY,rX+cR,rY,cR);ig.system.context.stroke();}});});
...
// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','impact.font','plugins.darcy','impact.debug.debug').defines(function(){MyGame=ig.Game.extend({font:new ig.Font('media/04b03.font.png'),darcy:new ig.Darcy(),darcy2:new ig.Darcy(),init:function(){ig.input.bind(ig.KEY.MOUSE1,'shoot');this.darcy.ButtonProperties={FontFillStyle:"red",FontFillOverStyle:"white",Font:"14pt arial",TextAlign:"center",Spacing:{x:5,y:5},ButtonSize:{x:100,y:30},DrawBoxes:true,BoxStrokeStyle:"#fff",BoxStrokeWidth:2,Corner:5,BackFillOverStyle:"pink",BackFillStyle:"purple"};this.darcy.DrawMenuBorder=true;this.darcy.MenuBorderStyle="orange";this.darcy.MenuBorderWidth="2";this.darcy.MenuBorderCorner=0;this.darcy.MenuLayout="H";this.darcy.MenuStart.x=5;this.darcy.MenuStart.y=5;this.darcy.addItem("voilett","dog","shoot",function(){console.log("german shepard dog");});this.darcy.addItem("polaris","cat","shoot",function(){console.log("black cat");});this.darcy.addItem("atticus","horse","shoot",function(){console.log("horse");});this.darcy2.ButtonProperties={FontFillOverStyle:"white",FontFillStyle:"red",Font:"12pt serif",TextAlign:"center",Spacing:{x:5,y:5},ButtonSize:{x:100,y:20},DrawBoxes:true,BoxStrokeStyle:"#fff",BoxStrokeWidth:2,BackFillOverStyle:"grey",BackFillStyle:"brown"};this.darcy2.DrawMenuBorder=true;this.darcy2.MenuBorderStyle="orange";this.darcy2.MenuBorderWidth="2";this.darcy2.MenuLayout="V";this.darcy2.MenuStart.x=20;this.darcy2.MenuStart.y=65;this.darcy2.addItem("voilett","dog","shoot",function(){console.log("german shepard dog");});this.darcy2.addItem("polaris","cat","shoot",function(){console.log("black cat");});this.darcy2.addItem("atticus","horse","shoot",function(){console.log("horse");});},update:function(){this.darcy.update();this.darcy2.update();this.parent();},draw:function(){this.parent();var x=ig.system.width/2,y=ig.system.height/2;this.font.draw('It Works!',x,y,ig.Font.ALIGN.CENTER);this.darcy.draw();this.darcy2.draw();}});ig.main('#canvas',MyGame,60,320,240,2);});