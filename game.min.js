...
console.log(dItem);this.MenuItems.push(dItem);},rebuildMenu:function()
{for(i=0;i<this.MenuItems.length;i++)
{if(this.MenuLayout=="V")
...
{this.inputEvent();}}},draw:function(){if(this.MenuLayout=="V")
