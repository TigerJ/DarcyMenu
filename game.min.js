...
ig.system.context.fillText(this.text,this.leftBounds+((this.rightBounds-this.leftBounds)/2),this.lowerBounds-((this.lowerBounds-this.upperBounds)/2)+(this.boxStrokeWidth*2));},drawBorders:function(){if(this.drawBox&&(this.CornerRad==0||this.CornerRad==undefined))
