    ...
    ig.Darcy = ig.Class.extend({
        ...
        draw: function(){
            ...
            else
            {
                ...
                {
                    //console.log('border drawing');
                    if(this.MenuBorderCorner==0 || this.MenuBorderCorner==undefined)
                    {
                        console.log(this.MenuStart.x+this.MenuSize.width);
                        ig.system.context.strokeStyle=this.MenuBorderStyle;
                        ig.system.context.lineWidth=this.MenuBorderWidth;
                        ig.system.context.strokeRect(this.MenuStart.x,this.MenuStart.y,this.MenuStart.x+this.MenuSize.width,this.MenuStart.y+this.MenuSize.height); 
        ...
        addItem: function(menutext, menulabel, inputAction, inputEvent){
            ...
            if(this.MenuLayout=="H")
            {
                ...
                {
                    spaceFirst={x:this.MenuPadding.x,y:this.MenuPadding.y};
                }
                else
                {
                    spaceFirst={x:0,y:this.MenuPadding.y};
                }
