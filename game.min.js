...
ig.system.context.fillText(this.text,this.leftBounds+((this.rightBounds-this.leftBounds)/2),this.lowerBounds-((this.lowerBounds-this.upperBounds)/2)+(this.boxStrokeWidth*2));},drawBackground:function(){var CT=new ig.ContextTools();if(this.isOver)
...
{CT.drawContextFillRectCorner(ig.system.context.fillStyle,this.rightBounds-this.leftBounds,this.lowerBounds-this.upperBounds,this.leftBounds,this.upperBounds,this.CornerRad);}},drawBorders:function(){var CT=new ig.ContextTools();if(this.drawBox&&(this.CornerRad==0||this.CornerRad==undefined))
...
{ig.system.context.strokeStyle=StrokeStyle;ig.system.context.lineWidth=LineWidth;ig.system.context.beginPath();ig.system.context.moveTo(rX+cR,rY);ig.system.context.lineTo(rX+rW-cR,rY);ig.system.context.arcTo(rX+rW,rY,rX+rW,rY+cR,cR);ig.system.context.lineTo(rX+rW,rY+rH-cR);ig.system.context.arcTo(rX+rW,rY+rH,rX-cR,rY+rH,cR);ig.system.context.lineTo(rX+cR,rY+rH);ig.system.context.arcTo(rX,rY+rH,rX,rH-cR,cR);ig.system.context.lineTo(rX,rY+cR);ig.system.context.arcTo(rX,rY,rX+cR,rY,cR);ig.system.context.stroke();},drawContextFillRectCorner:function(FillStyle,rW,rH,rX,rY,cR)
{ig.system.context.strokeStyle=FillStyle;ig.system.context.beginPath();ig.system.context.moveTo(rX+cR,rY);ig.system.context.lineTo(rX+rW-cR,rY);ig.system.context.arcTo(rX+rW,rY,rX+rW,rY+cR,cR);ig.system.context.lineTo(rX+rW,rY+rH-cR);ig.system.context.arcTo(rX+rW,rY+rH,rX-cR,rY+rH,cR);ig.system.context.lineTo(rX+cR,rY+rH);ig.system.context.arcTo(rX,rY+rH,rX,rH-cR,cR);ig.system.context.lineTo(rX,rY+cR);ig.system.context.arcTo(rX,rY,rX+cR,rY,cR);ig.system.context.fill();}});});
